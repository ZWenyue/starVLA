"""RoboTwin eval client for StarVLA policies.

Supports:
  - Native 14-D Robotwin / Agilex checkpoints (legacy).
  - unified80 ALOHA post-train checkpoints (80-D sparse layout + optional
    embodiment prompt + proprio state), matching
    ``data-juicer/.../configs/embodiments/aloha.yaml``.
"""
